               ...
               <section class="s-pageheader pageheader">
                    <div class="row">
                        <div class="column xl-12">
                            <h1 class="page-title">
                                <span class="page-title__small-type text-pretitle">Tentang Kami</span>
                                Kelompok 7
                            </h1>                            
                        </div>
                    </div>
               ...
               <section class="s-pagecontent pagecontent">
                    ...
                    <div class="row pageintro">
                        <div class="column xl-6 lg-12">
                            <h2 class="text-display-title">Teknik Informatika<br>
                                Pagi A 23</h2>
                        </div>
                        <div class="column xl-6 lg-12 u-flexitem-x-right">
                            <p class="lead">
                            Kami berharap dengan adanya kami mengerjakan projek web ini bisa membantu nilai kuliah kami, dan masukan dan saran sangat kami butuhkan untuk masa depan yang lebih baik. 
                            Ini tidak mudah bagi kami, namun kami telah melakukan sebisa kami. 
                            Terima Kasih.
                            </p>
                        </div>                       
                    </div> <!-- pageintro -->   
                    ...
                    <div class="row pagemedia">
                        <d class="column xl-12">
                            <figure class="page-media">                                
                                <img src="{{asset('storage')}}/assets/images/thumbs/contact/contact-1200.jpg" 
                        ...
                        <div class="column xl-12">
                            ...
                            <div class="row">
                                ...
                                <div class="column xl-5 md-12 u-flexitem-x-right">
                                    ...
                                    <div class="contact-block">
                                        <h6>Email</h6>
                                        <a href="mailto:#0">aliaazizahmasykur@gmail.com</a>
                                    </div>

                                    <div class="contact-block">
                                        <h6>Phone</h6>
                                        <ul class="contact-list">
                                            <li><a href="tel:197-543-2345">+62123456789</a></li>
                                            <li><a href="tel:197-123-9876">+01382004965</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
